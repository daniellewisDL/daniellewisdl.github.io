...
UW.LEVELS = [
  ...
  { n: 2,  name: "Fagin's Rooftops",           theme: 'rooftops', act: 1, len: 110, music: 'act1', hazards: { pickpocket: 2, beadle: 2, rat: 2 }, redmoon: true, amp: 7, gaps: 0.2 },
  ...
  { n: 8,  name: 'The Marshes at Dawn',        theme: 'marsh',    act: 4, len: 110, music: 'act4', hazards: { convict: 1, trap: 5 }, fog: true, amp: 2, gaps: 0.05, bogs: true, tiles: false,
    pal: { ground: '#3a3b33', ground2: '#54564a', plat: '#4c4e42' } },
