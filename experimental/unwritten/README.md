...
**Touch (mobile):** drag on the left half to move (works as a floating stick), tap/hold the right
half to jump or confirm, tap the ☰ in the top-right corner for the map.
